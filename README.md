...
* <a href="#cases">Список реализованных тестов</a>
...
____
<a id="cases"></a>
## <a name="Список реализованных тестов">**Список реализованных тестов:**</a>
____
- ✓ *Проверить успешные результаты поиска в приложении Wikipedia*
- ✓ *Проверить сообщение об ошибке при неудачном поиске в приложении Wikipedia*
- ✓ *Проверка наличия регистрации в приложении Wikipedia* 
- ✓ *Проверка стартовых страниц Wikipedia*
- ✓ *Проверка поиска Wikipedia*
- ✓ *Успешный поиск Appium*
- ✓ *Видимость заголовка*
____
<a id="jenkins"></a>
...
____
<p align="center">
<img title="Ios Video" src="images/video/Android.gif" width="700" alt="video">   
</p>
